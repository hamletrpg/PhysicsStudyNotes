...
typedef struct mat4
{
    union
    {
        struct
        {
            // nice to to extract matrices values canonically from a math perspective, but dude, as a programmer this sucks lol
    ...
    inline mat4(float f11, float f12, float f13, float f14, float f21, float f22, float f23, float f24, float f31, float f32, float f33, float f34, float f41, float f42, float f43, float f44)
    {
...
mat4 AxiAngle(const vec3& axis, float angle);
mat3 AxiAngle3x3(const vec3& axis, float angle);
